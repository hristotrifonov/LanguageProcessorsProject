...
static int   GetToken( int *offset )
{
    ...
    if ( token == KEYWORD )  {
        ...
        if ( 0 == strcmp( buffer, "HALT" ) )            token = HALT;
        else if ( 0 == strcmp( buffer, "ADD" ) )        token = ADD;
        else if ( 0 == strcmp( buffer, "SUB" ) )        token = SUB;
        else if ( 0 == strcmp( buffer, "MULT" ) )       token = MULT;
        else if ( 0 == strcmp( buffer, "DIV" ) )        token = DIV;
        else if ( 0 == strcmp( buffer, "NEG" ) )        token = NEG;
        else if ( 0 == strcmp( buffer, "BR" ) )         token = BR;
        else if ( 0 == strcmp( buffer, "BGZ" ) )        token = BGZ;
        else if ( 0 == strcmp( buffer, "BG" ) )         token = BG;
        else if ( 0 == strcmp( buffer, "BLZ" ) )        token = BLZ;
        else if ( 0 == strcmp( buffer, "BL" ) )         token = BL;
        else if ( 0 == strcmp( buffer, "BZ" ) )         token = BZ;
        else if ( 0 == strcmp( buffer, "BNZ" ) )        token = BNZ;
        else if ( 0 == strcmp( buffer, "CALL" ) )       token = CALL;
        else if ( 0 == strcmp( buffer, "RET" ) )        token = RET;
        else if ( 0 == strcmp( buffer, "BSF" ) )        token = BSF;
        else if ( 0 == strcmp( buffer, "RSF" ) )        token = RSF;
        else if ( 0 == strcmp( buffer, "LDP" ) )        token = LDP;
        else if ( 0 == strcmp( buffer, "RDP" ) )        token = RDP;
        else if ( 0 == strcmp( buffer, "INC" ) )        token = INC;
        else if ( 0 == strcmp( buffer, "DEC" ) )        token = DEC;
        else if ( 0 == strcmp( buffer, "PUSH" ) )       token = PUSHFP;
        else if ( 0 == strcmp( buffer, "LOAD" ) )       token = LOAD;
        else if ( 0 == strcmp( buffer, "STORE" ) )      token = STORE;
        else if ( 0 == strcmp( buffer, "READ" ) )       token = READ;
        else if ( 0 == strcmp( buffer, "WRITE" ) )      token = WRITE;
        else if ( 0 == strcmp( buffer, "FP" ) )         token = FP;
